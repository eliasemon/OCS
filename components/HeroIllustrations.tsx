"use client"
import { Terminal, Box, Cpu, Code2, Layers, Monitor, HardDrive, Server, Laptop } from "lucide-react"
  ...
  return (
    <div className="relative w-64 h-64 sm:w-80 sm:h-80 flex items-center justify-center perspective-[1000px]">
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        {/* Circular OS showcase */}
        <div className="relative w-48 h-48 sm:w-56 sm:h-56 z-10 animate-[spin_20s_linear_infinite]">
          {/* Windows */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl p-4 shadow-[0_0_30px_rgba(34,211,238,0.5)] animate-[spin_20s_linear_infinite_reverse]">
            <svg viewBox="0 0 448 512" className="w-8 h-8 text-white fill-current">
              <path d="M0 93.7l183.6-25.3v177.4H0V93.7zm0 324.6l183.6 25.3V268.4H0v149.9zm203.8 28L448 480V268.4H203.8v177.9zm0-380.6v180.1H448V32L203.8 65.7z"/>
            </svg>
          </div>
          
          {/* Mac */}
          <div className="absolute bottom-0 left-0 -translate-x-1/2 translate-y-1/2 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-2xl p-4 shadow-[0_0_30px_rgba(167,139,250,0.5)] animate-[spin_20s_linear_infinite_reverse]">
          ...
          {/* Linux */}
          <div className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl p-4 shadow-[0_0_30px_rgba(52,211,153,0.5)] animate-[spin_20s_linear_infinite_reverse]">
          ...
          {/* Central Hub */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background/50 backdrop-blur-md border border-[hsl(var(--color-border))] rounded-full p-6 shadow-2xl animate-[spin_20s_linear_infinite_reverse]">
            <Server className="w-10 h-10 text-[hsl(var(--color-primary))]" />
          </div>
        </div>
      </div>
    </div>
