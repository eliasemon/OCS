              ...
              <section>
                ...
                <pre className="mt-4 p-4 bg-[hsl(var(--color-card))] rounded-lg border border-[hsl(var(--color-border))] overflow-x-auto">
                  <code className="text-sm text-[hsl(var(--color-primary))]">
                    powershell -ExecutionPolicy Bypass -c "irm https://appnest-beta.vercel.app/api/install.ps1?apps=Git.Git,Google.Chrome | iex"
                  </code>
                </pre>
              </section>
          ...
          {activeTab === "mac" && (
            <div className="space-y-8">
              ...
              <section>
                ...
                <pre className="mt-4 p-4 bg-[hsl(var(--color-card))] rounded-lg border border-[hsl(var(--color-border))] overflow-x-auto">
                  <code className="text-sm text-[hsl(var(--color-primary))]">
                    curl -sSL "https://appnest-beta.vercel.app/api/mac/install.sh?apps=google-chrome,visual-studio-code" | bash
                  </code>
                </pre>
              </section>
            </div>
          ...
          {activeTab === "linux" && (
            <div className="space-y-8">
              ...
              <section>
                ...
                <pre className="mt-4 p-4 bg-[hsl(var(--color-card))] rounded-lg border border-[hsl(var(--color-border))] overflow-x-auto">
                  <code className="text-sm text-[hsl(var(--color-primary))]">
                    curl -sSL "https://appnest-beta.vercel.app/api/linux/install.sh?apps=git,curl,vlc" | bash
                  </code>
                </pre>
              </section>
