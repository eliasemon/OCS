    ...
    <div className="min-h-screen bg-[hsl(var(--color-background))] text-[hsl(var(--color-foreground))]">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <Link href="/" className="text-[hsl(var(--color-primary))] hover:text-[hsl(var(--color-primary-hover))] transition-colors">
          &larr; Back to Installora
        </Link>

        <h1 className="text-4xl font-bold mt-8 mb-4">Installora Documentation</h1>
        ...
        <div className="animate-in fade-in duration-300">
          {activeTab === "windows" && (
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-[hsl(var(--color-primary))]">What is Installora for Windows?</h2>
                <p className="mt-2 text-[hsl(var(--color-muted-foreground))]">
                  Installora on Windows leverages <strong>winget</strong> (Windows Package Manager) to help you install applications seamlessly. 
              ...
              <section>
                ...
                <dl className="mt-4 space-y-4">
                  <div>
                    ...
                    <dd className="text-[hsl(var(--color-muted-foreground))]">Yes. Installora only generates PowerShell scripts that use winget, Microsoft's official package manager.</dd>
                  </div>
                  <div>
          ...
          {activeTab === "mac" && (
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-[hsl(var(--color-primary))]">What is Installora for macOS?</h2>
                <p className="mt-2 text-[hsl(var(--color-muted-foreground))]">
                  Installora on macOS uses <strong>Homebrew</strong>, the missing package manager for macOS, to install applications and developer tools. 
          ...
          {activeTab === "linux" && (
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-[hsl(var(--color-primary))]">What is Installora for Linux?</h2>
                <p className="mt-2 text-[hsl(var(--color-muted-foreground))]">
                  Installora on Linux supports multiple package managers (APT, Flatpak, Snap) to install applications across different distributions like Ubuntu, Debian, Fedora, and Arch.
                </p>
              </section>
